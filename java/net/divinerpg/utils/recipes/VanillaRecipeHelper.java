...
public class VanillaRecipeHelper extends RecipeUtil {
	...
	public static void init(){
		...
		addinstance(VanillaBlocks.realmiteOre, VanillaItemsOther.realmiteIngot, 0.7F);
		addinstance(VanillaBlocks.arlemiteOre, VanillaItemsOther.arlemiteIngot, 1.0F);
		addinstance(VanillaBlocks.rupeeOre, VanillaItemsOther.rupeeIngot, 1.0F);
		addinstance(VanillaBlocks.netheriteOre, VanillaItemsOther.netheriteIngot, 1.1F);
		addinstance(VanillaBlocks.bloodgemOre, VanillaItemsOther.bloodgem, 1.2F);
		addinstance(VanillaItemsOther.pureAquaticPellets, VanillaItemsOther.aquaticIngot, 0.6F);
		...
		addinstance(ItemsFood.rawEmpoweredMeat, ItemsFood.empoweredMeat, 1);
		...
		addinstance(Items.egg, ItemsFood.boiledEgg, 0.3F);
		addinstance(Blocks.pumpkin, ItemsFood.hotPie, 0.3F);
