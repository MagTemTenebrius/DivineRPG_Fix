...
public class RecipeUtil {
	...
	protected static void addinstance(ItemStack input, ItemStack output, float XP) {
        GameRegistry.addSmelting(input, output, XP);
    }
	protected static void addinstance(Item input, Item output, float XP) {
        GameRegistry.addSmelting(new ItemStack(input, 1), new ItemStack(output, 1), XP);
    }
	protected static void addinstance(Block input, Block output, float XP) {
        GameRegistry.addSmelting(new ItemStack(input, 1), new ItemStack(output, 1), XP);
    }
	protected static void addinstance(Block input, Item output, float XP) {
        GameRegistry.addSmelting(new ItemStack(input, 1), new ItemStack(output, 1), XP);
    }
	protected static void addinstance(Item input, Block output, float XP) {
        GameRegistry.addSmelting(new ItemStack(input, 1), new ItemStack(output, 1), XP);
    }
