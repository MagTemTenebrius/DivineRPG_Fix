...
public class TwilightRecipeHelper extends RecipeUtil {
	...
	public static void init() {
		...
		addinstance(TwilightItemsOther.edenFragments, TwilightItemsOther.edenSparkles, 1);
		...
		addinstance(TwilightBlocks.edenOre, TwilightItemsOther.edenFragments, 0.7F);
		addinstance(TwilightBlocks.wildwoodOre, TwilightItemsOther.wildwoodFragments, 1.0F);
		addinstance(TwilightBlocks.apalachiaOre, TwilightItemsOther.apalachiaFragments, 1.3F);
		addinstance(TwilightBlocks.skythernOre, TwilightItemsOther.skythernFragments, 1.7F);
		addinstance(TwilightBlocks.mortumOre, TwilightItemsOther.mortumFragments, 2.0F);
